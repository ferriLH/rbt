...
<!--					<a href="--><?php //echo base_url('assets/main_page/')?><!--browse.html"><h4 class="tittle third">See all</h4></a>-->
	...
	<div class="review-slider">
		...
		<div class="tittle-head">
			<h3 class="tittle">Featured Artist <span class="new"> Recommended</span></h3>
			<div class="clearfix"> </div>
		</div>
		<ul id="flexiselDemo1">
			<?php if (isset($featured)) {
				foreach ($featured as $art) {
					...
					?>
					<li>
						<a href="<?php echo base_url('artist/detail/'),$id_a?>"><img src="<?php echo base_url('assets/foto_artis/')?><?php echo $art->picture_artist;?>" alt=""/></a>
						<div class="slide-title"><h4><?php echo $art->nama_artist?></div>
						<div class="date-city">
							<h5><?php echo $art->nama_artist?></h5>
							<div class="buy-tickets">
								<a href="<?php echo base_url('album/detail/'),$id_a?>">READ MORE</a>
							</div>
						</div>
					</li>
				<?php }?>
