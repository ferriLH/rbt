									...
									<div class="modal-body" style="padding: 15px 15px;">
										...
										<div class="row">
											...
											<div class="col-sm-4">
												...
												<small><?php echo "Tarif : ".$dat->harga_tsel1."/lagu"?></small>
												<small>Untuk Berlangganan selama ... bulan,</small> <br><?php
												if ($this->agent->is_mobile('iphone')||$this->agent->is_mobile('ipod')||$this->agent->is_mobile('ipad'))
												{
													echo "<a href='sms:1212&body=RING SUB ".$dat->kode_tsel1."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}elseif ($this->agent->is_mobile('android'))
												{
													echo "<a href='sms:1212?body=RING SUB ".$dat->kode_tsel1."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}else
												...
												if ($this->agent->is_mobile('iphone')||$this->agent->is_mobile('ipod')||$this->agent->is_mobile('ipad'))
												{
													echo "<a href='sms:1212&body=RING SUB ".$dat->kode_tsel2."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}elseif ($this->agent->is_mobile('android'))
												{
													echo "<a href='sms:1212?body=RING SUB ".$dat->kode_tsel2."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}else
												...
												<small>Untuk Berlangganan selama ... bulan,</small><br>
												<?php
												if ($this->agent->is_mobile('iphone')||$this->agent->is_mobile('ipod')||$this->agent->is_mobile('ipad'))
												{
													echo "<a href='sms:1212&body=RING SUB ".$dat->kode_tsel3."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}elseif ($this->agent->is_mobile('android'))
												{
													echo "<a href='sms:1212?body=RING SUB ".$dat->kode_tsel3."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}else
												...
												if ($this->agent->is_mobile('iphone')||$this->agent->is_mobile('ipod')||$this->agent->is_mobile('ipad'))
												{
													echo "<a href='sms:1212&body=RING SUB ".$dat->kode_tsel4."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}elseif ($this->agent->is_mobile('android'))
												{
													echo "<a href='sms:1212?body=RING SUB ".$dat->kode_tsel4."'><button class='btn btn-default'>Kirim SMS</button></a>";
												}else
