			...
			<div class="col-xs-12 col-sm-12 col-md-7 excerpet">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<br>
						<small><?php echo "Ketik : <b>RING</b> (spasi)<b> SUB</b> (spasi) <b>".$r->kode_tsel."</b>"?></small><br>
						<small><?php echo "Kirim ke : <b>1212</b>"?></small> <br>
						<small><?php echo "Tarif : ".$r->harga_tsel."/lagu"?></small> <br><br>
						<small>Untuk Memberikan nada sambung ke teman,</small> <br>
						<small>
							<?php echo "Ketik : <b>RING</b> (spasi)<b> GIFT</b> (spasi) <b>".$r->kode_tsel."</b> (spasi)<b> Nomor HP teman</b>"?>
						</small><br>
						<small><?php echo "Kirim ke : <b>1212</b>"?></small> <br>
						<?php
						if ($this->agent->is_mobile('iphone')||$this->agent->is_mobile('ipod')||$this->agent->is_mobile('ipad'))
						{
							echo "<a href='sms:1212&body=RING SUB ".$r->kode_tsel."'><button class='btn btn-default'>Kirim SMS</button></a>";
						}elseif ($this->agent->is_mobile('android'))
						{
							echo "<a href='sms:1212?body=RING SUB ".$r->kode_tsel."'><button class='btn btn-default'>Kirim SMS</button></a>";
						}else
