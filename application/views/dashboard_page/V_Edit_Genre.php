			...
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" action="<?php echo base_url('update-genre-auth/').$getGenreEdit[0]['id']?>" method="post">
							...
							<div class="form-group">
								...
								<input value="<?php echo $getGenreEdit[0]['genre']?>"
									type="text" name="nama_genre" class="form-control" id="nama_genre" placeholder="Nama Genre">
							</div>
