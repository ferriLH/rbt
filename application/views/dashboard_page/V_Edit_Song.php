			...
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" action="<?php echo base_url('update-song-auth/').$getSongEdit[0]['id_lagu']?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input value="<?php echo $getSongEdit[0]['judul']?>"
									type="text" class="form-control" id="judul_lagu" placeholder="Judul Lagu" name="judul_lagu">
							</div>
							<div class="form-group">
								<label for="bio">harga</label>
								<input value="<?php echo $getSongEdit[0]['harga']?>"
									type="number" placeholder="Harga" class="form-control" id="harga" name="harga">
							</div>
							<div class="form-group">
								<label for="kode_registration">Kode Registrasi XL</label>
								<input value="<?php echo $getSongEdit[0]['kode_xl']?>"
							...
							<div class="form-group">
								...
								<input value="<?php echo $getSongEdit[0]['kode_indosat']?>"
									   type="text" placeholder="Kode Registrasi" class="form-control" id="kode_registration" name="indosat">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<select class="form-control" id="album" name="album">
									<option value="<?php echo $getSongEdit[0]['album_id']?>"><?php echo $getSongEdit[0]['nama_album']?></option>
							...
							<div class="form-group">
								...
								<select class="form-control" id="genre" name="genre">
									<option value="<?php echo $getSongEdit[0]['genre_id']?>"><?php echo $getSongEdit[0]['genre']?></option>
