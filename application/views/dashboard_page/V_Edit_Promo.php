			...
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" action="<?php echo base_url('update-promo/auth/').$getPromoEdit[0]['id_promo']?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input value="<?php echo $getPromoEdit[0]['nama_promo']?>"
									type="text" class="form-control" id="nama_promo" placeholder="Nama Promo" name="nama_promo">
							</div>
							<div class="form-group">
								<label for="mekanisme_promo">Mekanisme Promo</label>
								<textarea class="form-control" id="mekanisme_promo" rows="5" name="mekanisme_promo" placeholder=""><?php echo $getPromoEdit[0]['mekanisme']?></textarea>
							</div>
							<div class="form-group">
								<label for="periode_promo">Periode Promo</label>
								<input value="<?php echo $getPromoEdit[0]['periode']?>"
									type="text" class="form-control" id="periode_promo" placeholder="e.g 20 Agustus - 30 September" name="periode_promo">
							</div>
							<div class="form-group">
								<label for="status_promo">Status Aktif Promo</label>
								<select class="form-control" id="status_promo" name="status_promo">
									<option <?php if ($getPromoEdit[0]['aktif']==0)echo "selected";?> value="0">Tidak Aktif</option>
									<option <?php if ($getPromoEdit[0]['aktif']==1)echo "selected";?> value="1">Aktif</option>
								</select>
							</div>
							<div class="form-group">
