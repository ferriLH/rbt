				...
				<div class="col-lg-4 mx-auto">
					<div class="auth-form-light text-left py-5 px-4 px-sm-5">
						<div class="brand-logo">
                            <img src="<?php echo base_url()?>assets/main_page/images/Homelogo.png" alt="logo">
                        </div>
                        ...
                        <form class="pt-3" method="post" action="<?php echo base_url('login/auth')?>">
							...
							<br>
							<div class="mb-2">
								<button onclick="back()" href="<?php echo base_url('')?>" type="button" class="btn btn-block btn-facebook auth-form-btn">
